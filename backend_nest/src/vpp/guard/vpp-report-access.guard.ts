...
@Injectable()
export class VppReportAccessGuard implements CanActivate {
  constructor(
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    if (!userId) {
      throw new ForbiddenException('Bạn không có quyền truy cập báo cáo VPP.');
    }
    ...
    throw new ForbiddenException(
      'Chỉ quản lý, ban giám đốc, cán bộ, công ty mới được xem báo cáo VPP.',
    );
  }
